                ...
                {randomPoem ? (
                  <div className="poem-display">
                    ...
                    <button 
                      className="share-btn" 
                      onClick={() => {
                          navigator.clipboard.writeText(`${API_BASE}/poema/${randomPoem.id}`);
                          alert("Link otimizado para SEO copiado para a área de transferência!");
                      }}
                      style={{marginTop: '15px', background: 'transparent', border: '1px solid #6366f1', color: '#6366f1', padding: '5px 10px', borderRadius: '5px', cursor: 'pointer', fontSize: '0.8rem', display: 'inline-flex', alignItems: 'center', gap: '5px', transition: 'all 0.2s ease'}}
                      onMouseOver={(e) => { e.currentTarget.style.background = 'rgba(99, 102, 241, 0.1)'; }}
                      onMouseOut={(e) => { e.currentTarget.style.background = 'transparent'; }}
                      title="Copiar link para WhatsApp/Twitter"
                    >
